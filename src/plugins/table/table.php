...
<tr><?
    switch($i)
    {
        case 0: ?><td>Великая Отечественная война советского народа(в контексте Второй мировой войны)</td>
        ...
        case 1:?><td>Охрана труда</td>
            ...
            <?break;
        case 2:?><td>Коррупция и её общественная опасность</td>
            <td id = "semestr <?=$i?>">1</td>
            <td id = "hours <?=$i?>">1</td>
            <?break;
        case 3:?>   <td>Экономика</td>
            <td id = "semestr <?=$i?>">1</td>
            <td id = "hours <?=$i?>">1</td>
            <?break;
    }?>
